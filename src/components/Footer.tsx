      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-blue-100 mb-6 leading-relaxed max-w-md">
              Transformamos empresas através da inteligência artificial, 
              liberando líderes visionários para focar no que realmente importa: 
              inovar e conquistar novos horizontes.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-electric-blue rounded-lg flex items-center justify-center hover:bg-soft-gold transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-100">
              <li><a href="#" className="hover:text-white transition-colors">Consultoria em IA</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Branding Inteligente</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Automação Marketing</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Sistemas Inteligentes</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-blue-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-100 text-sm">
            © 2024 Lumina X. Todos os direitos reservados.
          </p>
